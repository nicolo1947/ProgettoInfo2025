    ...
    public boolean letturaStudenti(String fn) {
        ...
        try {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                elencoStudenti.add(new Studente(nome, cognome, matricola, codice));
    ...
    public boolean letturaDocenti(String fn) {
        ...
        try {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                elencoDocenti.add(new Docente(nome, cognome, matricola, codice));
    ...
    public boolean letturaDisciplina(String fn) {
        ...
        try {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                elencoDiscipline.add(new Disciplina(codiceD, nome, cfu, codice));
            }
