...
public class GestoreStudenti {
    ...
    public boolean eliminaStudente(String matricola) {
        ...
        // Controlla se è iscritto a qualche appello (debug incluso)
        for (Appello a : S.elencoAppelli) {
            System.out.println("Controllo appello: " + a.getIdAppello() + " -> Iscritti: " + a.getIscritti().size());
            for (Studente iscr : a.getIscritti()) {
                System.out.println(" - " + iscr.getMatricola());
