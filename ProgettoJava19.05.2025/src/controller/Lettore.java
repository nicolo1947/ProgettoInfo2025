    ...
    public boolean letturaIscAppello(String fn) {
        ...
        try {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                // Qui devi verificare che la disciplina appartiene al corso dello studente
                // Supponiamo che elencoDiscipline sia disponibile (devi passarlo o accedere a S.elencoDiscipline)
